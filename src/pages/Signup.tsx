    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="max-w-md w-full bg-white/95 backdrop-blur rounded-2xl shadow-xl p-8 border border-slate-200">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-semibold text-slate-900 mt-4">Create account</h1>
          <p className="text-sm text-slate-500">Join PulseChat in seconds</p>
        </div>
        ...
        {authError && (
          <div className="mb-4 p-3 bg-rose-50 border border-rose-200 text-rose-700 rounded-xl">
            ...
            <button
              ...
              className="mt-2 text-xs text-rose-700 hover:text-rose-800 underline block"
            >
              Dismiss
            </button>
          </div>
